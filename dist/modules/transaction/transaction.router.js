...
router.get('/sales/:userId', transaction_controller_1.transactionController.getSalesById);
router.get('/purchases/:userId', transaction_controller_1.transactionController.getPurchasesById);
